      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service, index) => (
            <Card key={index} className="p-8 rounded-2xl border-purple-600 hover:border-purple-600 transition-all duration-300 hover:shadow-lg hover:scale-105">
              <div className="bg-gradient-to-br from-purple-600 to-blue-100 rounded-xl p-4 w-16 h-16 mb-6 flex items-center justify-center">
